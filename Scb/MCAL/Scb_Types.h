...
typedef enum
{
	BINARY_POINT1 = 0b011,      /*     Group Priority 16  Sub Priority None 0bxxxx  (X:Main Priority, Y:Sub Priority)  */
	BINARY_POINT2 = 0b100,      /*     Group Priority 8  Sub Priority 2     0bxxxy  (X:Main Priority, Y:Sub Priority)  */
	BINARY_POINT3 = 0b101,      /*     Group Priority 4  Sub Priority 4     0bxxyy  (X:Main Priority, Y:Sub Priority)  */
	BINARY_POINT4 = 0b110,      /*     Group Priority 2  Sub Priority 8     0bxyyy  (X:Main Priority, Y:Sub Priority)  */
	BINARY_POINT5 = 0b111       /*     Group Priority none  Sub Priority 16 0byyyy  (X:Main Priority, Y:Sub Priority)  */
