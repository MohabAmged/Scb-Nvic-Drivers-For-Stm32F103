...
typedef enum
{
	PRIGROUP1 = 0b011,      /*     Group Priority 16  Sub Priority None 0bxxxx (X:Priority ,Y:Sub Priority)    */
	PRIGROUP2 = 0b100,      /*     Group Priority 8  Sub Priority 2     0bxxxy (X:Priority ,Y:Sub Priority)   */
	PRIGROUP3 = 0b101,      /*     Group Priority 4  Sub Priority 4     0bxxyy (X:Priority ,Y:Sub Priority)   */
	PRIGROUP4 = 0b110,      /*     Group Priority 2  Sub Priority 8     0bxyyy (X:Priority ,Y:Sub Priority)   */
	PRIGROUP5 = 0b111       /*     Group Priority none  Sub Priority 16 0byyyy (X:Priority ,Y:Sub Priority)   */
